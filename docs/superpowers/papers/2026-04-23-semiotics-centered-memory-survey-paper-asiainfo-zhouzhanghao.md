...
> Author: Zhanghao Zhou, Technical Director, AsiaInfo Technologies (AsiaInfo)  
> Date: 2026-04-23  
...
![Figure 1: Teaser overview of the proposed semiotic memory architecture.](./images/fig1-architecture-overview.png)

*Figure 1. Teaser overview of the proposed semiotic memory architecture.*
...
![Figure 2: Schema of the proposed semiotic memory unit.](./images/fig2-smu-schema.png)

*Figure 2. Schema of the proposed semiotic memory unit.*
...
![Figure 3: Collective memory as a semiosphere with translation and propagation dynamics.](./images/fig3-semiosphere-propagation.png)

*Figure 3. Collective memory as a semiosphere with translation and propagation dynamics.*
...
![Figure 4: Evaluation roadmap for the proposed semiotic memory research agenda.](./images/fig4-evaluation-matrix.png)

*Figure 4. Evaluation roadmap for the proposed semiotic memory research agenda.*
...
> Author drafting notes, figure prompts, and internal self-review are maintained separately in [2026-04-23-semiotics-centered-memory-survey-paper-asiainfo-zhouzhanghao-author-notes.md](./2026-04-23-semiotics-centered-memory-survey-paper-asiainfo-zhouzhanghao-author-notes.md).
