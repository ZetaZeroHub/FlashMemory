...
# Author Notes for `2026-04-23-semiotics-centered-memory-survey-paper-asiainfo-zhouzhanghao.md`

- 日期：2026-04-23
- 状态：author companion notes
- 关系：配套 [2026-04-23-semiotics-centered-memory-survey-paper-asiainfo-zhouzhanghao.md](./2026-04-23-semiotics-centered-memory-survey-paper-asiainfo-zhouzhanghao.md) 的图像提示词与作者自检记录；默认不进入正式 arXiv 投稿正文
...
- Author: Zhanghao Zhou
- Role: Technical Director
- Affiliation: AsiaInfo Technologies (AsiaInfo)
- This named edition preserves the same technical thesis and structure as the anonymous draft while updating the authorship metadata for direct sharing.


## Figure Assets

- Figure 1 file: `./images/fig1-architecture-overview.png`
- Figure 2 file: `./images/fig2-smu-schema.png`
- Figure 3 file: `./images/fig3-semiosphere-propagation.png`
- Figure 4 file: `./images/fig4-evaluation-matrix.png`
