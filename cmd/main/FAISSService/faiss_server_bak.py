...
def add_vector():
    ...
    try:
        ...
        for internal_id, existing_func_id in index_data['id_map'].items():
        ...
        if existing_internal_ids:
            ...
            app.logger.info(f"Removed existing vector(s) for func_id {func_id} from index {index_id}")
